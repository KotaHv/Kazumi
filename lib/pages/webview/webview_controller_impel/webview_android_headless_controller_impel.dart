...
class WebviewAndroidItemControllerImpel
  ...
  final ValueNotifier<bool> shouldShowWebView = ValueNotifier(false);

  @override
  Future<void> init() async {
    debugPrint('[WebView] hasInjectedScripts: $hasInjectedScripts');
  ...
  Future<void> loadUrl(String url, bool useNativePlayer, bool useLegacyParser,
      {int offset = 0}) async {
    await unloadPage();
    if (!hasInjectedScripts || shouldShowWebView.value) {
      debugPrint('[WebView] Injecting JavaScript handlers and user scripts');
